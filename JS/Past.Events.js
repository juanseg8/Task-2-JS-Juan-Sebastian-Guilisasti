...
let currentDate = "2022-01-01"
    ...
    function paintDOM(pastevents) {
        ...
        <div class="card text-center">
         <img src=${pastEvents[i].image} class="card-img-top" alt="image" height="150px">
         <div class="card-body">
         ...
         <div class="card-footer text-muted">Date: ${pastEvents[i].date}</div>
         </div>
         </div>`;
        }
