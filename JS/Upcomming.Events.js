...
function paintDOM(upcomingEvents) {
    let body = ``;
    ...
    <div class="card text-center">
     <img src=${upComingEvents[i].image} class="card-img-top" alt="image" height="150px">
     <div class="card-body">
     ...
     <div class="card-footer text-muted">Date: ${upComingEvents[i].date}</div>
     </div>
     </div>`;
    }
